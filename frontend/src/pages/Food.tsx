  ...
  return (
    <>
      ...
      <div className="mx-auto max-w-7xl space-y-12 px-4 py-12">
        <section className="relative overflow-hidden rounded-[3.5rem] bg-gradient-to-br from-orange-600 to-red-700 p-8 md:p-16 text-white shadow-2xl shadow-orange-900/20">
          <div className="relative z-10 max-w-3xl space-y-6">
            ...
            <p className="text-xl leading-8 text-orange-50/80">
        ...
        <section className="rounded-[2.5rem] border border-slate-100 bg-white/90 p-4 shadow-xl shadow-orange-950/5 backdrop-blur-xl sm:sticky sm:top-24 sm:z-40">
        ...
        <section className="rounded-[3rem] bg-orange-50 p-12 md:p-16">
