...
export default function AdminLogin() {
  ...
  return (
    <div className="flex min-h-dvh items-center justify-center bg-slate-950 p-3 sm:p-4">
      <Card className="w-full max-w-md rounded-[1.5rem] border-slate-800 bg-white shadow-2xl sm:rounded-3xl">
